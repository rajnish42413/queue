...
|
*/
 Route::post('settings/fetch', ['as' => 'post_fetch', 'uses' => 'SettingsController@fetch']);
 Route::post('settings/fetch_cont', ['as' => 'fetch_cont', 'uses' => 'SettingsController@fetch_cont']);
...
Route::group(['middleware' => 'install'], function() {
	...
	Route::group(['middleware' => 'auth:users'], function() {
        ...
        Route::post('settings/create', ['as' => 'create', 'uses' => 'SettingsController@create']);
