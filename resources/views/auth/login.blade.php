...
<html>
    <head>
        ...
        <title>Login | UPSTUR QUEUE</title>
    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
            <div class="col s6 offset-s3 z-depth-4 card-panel center">
                <form class="login-form" action="{{ route('post_login') }}" method="post" onsubmit="return load()">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">UPSTUR QUEUE</p>
