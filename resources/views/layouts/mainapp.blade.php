...
<html>
    <head>
        ...
        <title>@yield('title') | UPSTUR QUEUE</title>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="{{ route('dashboard') }}" class="brand-logo darken-1">UPSTUR QUEUE</a></h1></li>
                        </ul>
                        ...
                        <ul class="right hide-on-med-and-down">
                            <span class="truncate">Welcome {{ $user->role_text }}</span>
                        </ul>
                    </div>
                </nav>
            </div>
                        ...
                        <li class="user-details cyan darken-2">
                            <div class="row">
                                <div class="col col s4 m4 l4">
                                    <img src="{{ asset('assets/images/avatar.png') }}" alt="" class="circle responsive-img valign profile-image">
                                </div>
