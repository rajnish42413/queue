...
@if (Auth::user()->role =="SA" || Auth::user()->role =="A")
                <div class="col s12 m6">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <form id="company" action="{{ route('post_company') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <label for="name">{{ trans('messages.name') }}</label>
                                        <input id="name" type="text" name="name" placeholder="{{ trans('messages.name') }}" value="{{ $setting->name }}" data-error=".cname">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <label for="email">{{ trans('messages.users.email') }}</label>
                                        <input id="email" type="text" name="email" placeholder="{{ trans('messages.users.email') }}" value="{{ $setting->email }}" data-error=".cemail">
                                        <div class="cemail">
                                            @if($errors->has('email'))<div id="name-error" class="error">{{ $errors->first('email') }}</div>@endif
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <textarea id="address" class="materialize-textarea" name="address" placeholder="{{ trans('messages.company.address') }}" data-error=".address" style="min-height:67px">{{ $setting->address }}</textarea>
                                        <div class="address">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="phone" type="text" name="phone" placeholder="{{ trans('messages.company.phone') }}" value="{{ $setting->phone }}" data-error=".phone">
                                        <div class="phone">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="location" type="text" name="location" placeholder="{{ trans('messages.company.location') }}" value="{{ $setting->location }}" data-error=".location">
                                        <div class="location">
                            ...
                            <form id="overmissed" action="{{ route('post_over_missed') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="over_time" type="text" name="over_time" placeholder="{{ trans('messages.in_seconds') }}" value="{{ $setting->over_time }}" data-error=".over_time">
                                        <div class="over_time">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="missed_time" type="text" name="missed_time" placeholder="{{ trans('messages.in_seconds') }}" value="{{ $setting->missed_time }}" data-error=".missed_time">
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <select id="language" class="browser-default" name="language" data-error=".language">
                                            @foreach($languages as $language)
                                                @if($language->id==$setting->language_id)
