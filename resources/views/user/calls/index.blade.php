                ...
                <div class="col s12 m6">
                 <div class="card">
                    <div class="card-content">
                        ...
                        <div class="divider" style="margin:10px 0 10px 0"></div>
                        @foreach($department as $dep)
                            <span class="btn waves-effect waves-light" onclick="call_dept({{ $dep->id }})" style="margin-bottom:10px;margin-right:5px;text-transform:none">{{ $dep->name }}</span>
                        @endforeach
                    </div>
                  </div>
               </div>
