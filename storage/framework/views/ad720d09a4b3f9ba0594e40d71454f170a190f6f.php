                        ...
                        <tbody>
                            <?php $__currentLoopData = $counters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $counter): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php 
                                        $dep = DB::table('departments')->where('id', $counter->dep )->first();
                                        echo $dep->name;
                                         ?>
                                    </td>
                                    <?php 
                                        $dep = DB::table('users')->where('id', $counter->vendor )->first();
                                        echo "<td>".$dep->username."</td>";
                                         $comp = DB::table('settings')->where('id', $dep->company )->first();
