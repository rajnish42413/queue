...
<html>
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | UPSTUR QUEUE</title>
    ...
    <body>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1">UPSTUR QUEUE</a></h1></li>
                        </ul>
                        ...
                        <ul class="right hide-on-med-and-down">
                            <span class="truncate">Welcome <?php echo e($user->role_text); ?></span>
                        </ul>
                    </div>
                </nav>
            </div>
                        ...
                        <li class="user-details cyan darken-2">
                            <div class="row">
                                <div class="col col s4 m4 l4">
                                    <img src="<?php echo e(asset('assets/images/avatar.png')); ?>" alt="" class="circle responsive-img valign profile-image">
                                </div>
        ...
        <footer class="page-footer">
            <div class="footer-copyright">
                <div class="container">
                    <span>Powered by <a class="grey-text text-lighten-3" href="https://upstur.com/" target="_blank">UPSTUR.COM</a> All rights reserved.</span>
