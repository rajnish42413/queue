<?php $__env->startSection('menu'); ?>
    ...
    <?php endif; ?>
     ...
     <?php if (app('Illuminate\Contracts\Auth\Access\Gate')->check('access', \App\Models\Company::class)): ?>
        <li class="bold<?php echo Request::is('company*') ? ' active' : ''; ?>"><a href="<?php echo e(route('company.index')); ?>" class="waves-effect waves-cyan truncate">
            <i class="mdi-social-group"></i> Companies</a>
        </li>
    <?php endif; ?>
