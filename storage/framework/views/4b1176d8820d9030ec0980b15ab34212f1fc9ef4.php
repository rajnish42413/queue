...
<?php if(Auth::user()->role =="SA" || Auth::user()->role =="A"): ?>
                <div class="col s12 m6">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <form id="company" action="<?php echo e(route('post_company')); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <label for="name"><?php echo e(trans('messages.name')); ?></label>
                                        <input id="name" type="text" name="name" placeholder="<?php echo e(trans('messages.name')); ?>" value="<?php echo e($setting->name); ?>" data-error=".cname">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <label for="email"><?php echo e(trans('messages.users.email')); ?></label>
                                        <input id="email" type="text" name="email" placeholder="<?php echo e(trans('messages.users.email')); ?>" value="<?php echo e($setting->email); ?>" data-error=".cemail">
                                        <div class="cemail">
                                            <?php if($errors->has('email')): ?><div id="name-error" class="error"><?php echo e($errors->first('email')); ?></div><?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <textarea id="address" class="materialize-textarea" name="address" placeholder="<?php echo e(trans('messages.company.address')); ?>" data-error=".address" style="min-height:67px"><?php echo e($setting->address); ?></textarea>
                                        <div class="address">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="phone" type="text" name="phone" placeholder="<?php echo e(trans('messages.company.phone')); ?>" value="<?php echo e($setting->phone); ?>" data-error=".phone">
                                        <div class="phone">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="location" type="text" name="location" placeholder="<?php echo e(trans('messages.company.location')); ?>" value="<?php echo e($setting->location); ?>" data-error=".location">
                                        <div class="location">
                            ...
                            <form id="overmissed" action="<?php echo e(route('post_over_missed')); ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="over_time" type="text" name="over_time" placeholder="<?php echo e(trans('messages.in_seconds')); ?>" value="<?php echo e($setting->over_time); ?>" data-error=".over_time">
                                        <div class="over_time">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <input id="missed_time" type="text" name="missed_time" placeholder="<?php echo e(trans('messages.in_seconds')); ?>" value="<?php echo e($setting->missed_time); ?>" data-error=".missed_time">
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <select id="language" class="browser-default" name="language" data-error=".language">
                                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <?php if($language->id==$setting->language_id): ?>
