                        ...
                        <form id="new_call" action="<?php echo e(route('post_call')); ?>" method="post">
                            ...
                            <?php else: ?>
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <select id="user" class="browser-default" name="user" data-error=".user" onchange="deps_byuser()">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <select id="department" class="browser-default" name="department" data-error=".department" onchange="dep_counter()" disabled>
                            ...
                            <?php else: ?>
                              <div class="row">
                                <div class="input-field col s12">
                                    <label for="department" class="active"><?php echo e(trans('messages.mainapp.menu.department')); ?></label>
                                    <select id="department" class="browser-default" name="department" data-error=".department" onchange="dep_counter()">
                                        <option value=""><?php echo e(trans('messages.select')); ?> <?php echo e(trans('messages.mainapp.menu.department')); ?></option>
                                        <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <?php if(session()->has('department') && ($department->id==session()->get('department'))): ?>
                                                <option value="<?php echo e($dep->id); ?>" selected><?php echo e($dep->name); ?></option>
                                            <?php else: ?>
                ...
                <div class="col s12 m6">
                 <div class="card">
                    <div class="card-content">
                        ...
                        <div class="divider" style="margin:10px 0 10px 0"></div>
                        <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <span class="btn waves-effect waves-light" onclick="call_dept(<?php echo e($dep->id); ?>)" style="margin-bottom:10px;margin-right:5px;text-transform:none"><?php echo e($dep->name); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </div>
                  </div>
               </div>
...
<script type="text/javascript">
    ...
    function dep_counter() {    
      var v_id =$('#department').val();
      var _token = $('input[name="_token"]').val();
       ...
       else
       {
        ...
        $.ajax({
            url:'<?php echo e(route('fetch_cont')); ?>',
            type:"POST",
